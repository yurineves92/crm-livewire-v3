...
<body class="font-sans text-slate-900 antialiased">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex w-1/2 bg-brand-600 flex-col items-center justify-center p-12 text-white">
            <h1 class="text-4xl font-extrabold tracking-tight mb-4">CRM Livewire</h1>
            <p class="text-brand-100 text-center text-lg max-w-sm">
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 bg-slate-50">
            ...
            <div class="w-full max-w-sm">
                <div class="mb-8">
                    ...
                    <p class="text-slate-500 mt-1 text-sm">Acesse sua conta para continuar.</p>
                </div>

                <div class="bg-white shadow-card rounded-xl border border-slate-200/70 px-6 py-8">
                    {{ $slot }}
                </div>
            </div>
        </div>
